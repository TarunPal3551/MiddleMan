...
public class InProcessAdapter extends RecyclerView.Adapter<InProcessAdapter.ViewHolder> {
    ...
    public InProcessAdapter(Context mcontext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.inprocess_item, parent, false);
...
//                dialog.setContentView(R.layout.dialog_locations);
//                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
//
//                Button cancelBTN = dialog.findViewById(R.id.closeButton);
//                RecyclerView recyclerViewlocation = dialog.findViewById(R.id.locationRecyclerView);
//                recyclerViewlocation.setLayoutManager(new LinearLayoutManager(mcontext));
//                recyclerViewlocation.setAdapter(new DeliveryLocationAdapter(mcontext));
